<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmRegister.aspx.cs" Inherits="BTL_Example.theme.FrmRegister" %>
    ...
    <div class="form-container w-100 min-vh-100 d-flex justify-content-center align-items-center flex-wrap">
        <div class="wrap-form-login d-flex justify-content-between bg-white align-items-center">
            ...
            <form class="form-submit" runat="server">
                <span class="title font-weight-bold">Đăng ký người dùng</span>
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <asp:RequiredFieldValidator ID="validRePassword"
                        ForeColor="Red"
                        Font-Italic="true"
                        Font-Size="Small"
                        CssClass="ml-3"
                        runat="server" ErrorMessage="Mật khẩu nhập lại không được để trống"
                ...
                <div class="mt-3">
                    <asp:Button ID="login"
                        ...
                        runat="server" Text="Đăng ký" OnClick="processRegister" />
                </div>
            </form>
            <div class="url-register">
                <a class="font-italic small text-secondary text-decoration-none" href="FrmLogin.aspx">
